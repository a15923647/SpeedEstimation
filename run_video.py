...
if __name__ == '__main__':
    ...
    parser.add_argument('--outdir', type=str, default='./vis_depth_v2')
    ...
    while cap.isOpened():
        ...
        if args.save_numpy:
            output_path = os.path.join(args.outdir, f'frame_{frame_count:05d}_raw_depth_meter.npy')
        ...
        output_path = os.path.join(args.outdir, f'frame_{frame_count:05d}.png')
        if args.pred_only:
    ...
    cap.release()
    print("Processing complete. Frames saved in output directory.")
